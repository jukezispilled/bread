...
function App() {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center bg-[#32FF53] relative overflow-clip">
      <div className='absolute top-5 text-xs md:text-lg font-semibold'>CA: 3d1o1Rn5DjRHxFW98htDh9yErKiCLdVngDEkRaBRpump</div>
      <img src="br.png" className='w-[45%] md:w-[35%] absolute left-0 bottom-0' alt="Background" />
      ...
      <div className="w-[85vw] md:w-96 h-[600px] bg-white rounded-2xl border flex flex-col z-10 relative overflow-hidden">
        <div className="bg-gray-100 p-4 flex items-center justify-between">
          ...
          <div className="flex space-x-1">
            <a href="https://x.com/lgtbreadsolana" className='transition ease-in-out duration-150'>
            ...
            <a href="https://t.me/breadsolanaa" className='transition ease-in-out duration-150'>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2 bg-white relative" style={{ backgroundImage: 'linear-gradient(180deg, #f0f0f0 0%, #ffffff 100%)' }}>
          <AnimatePresence>
